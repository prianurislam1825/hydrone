...
import { PlaneTakeoff, Navigation, Filter, BarChart3, CheckCircle2 } from 'lucide-react'
...
export default function HowItWorks() {
  ...
  return (
    <section id="cara-kerja" className="py-24 bg-[#CAF0F8]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {STEPS.map((step, i) => (
            ...
            >
              ...
              <h3 className="font-bold text-[#0D1B2A] text-base mb-2">{step.title[lang]}</h3>
              <p className="text-[#0D1B2A]/60 text-sm leading-relaxed">{step.desc[lang]}</p>
            </div>
          ))}
        </div>
        ...
        {/* Result banner */}
        <div
          className="bg-gradient-to-r from-[#1565C0] to-[#00B4D8] rounded-2xl p-6 flex items-center justify-center gap-3 text-white shadow-xl"
          data-anim
        >
