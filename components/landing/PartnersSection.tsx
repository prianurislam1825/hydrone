...
export default function PartnersSection() {
  ...
  return (
    <section className="py-20 border-y" style={{ background: 'var(--t-surface)', borderColor: 'var(--t-border)' }}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-wrap justify-center items-center gap-8 sm:gap-12" data-anim>
          {PARTNERS.map((p, i) => (
        ...
        <p className="mt-12 text-sm max-w-lg mx-auto" style={{ color: 'var(--t-muted)' }} data-anim>
          {T.heading[lang]}
        </p>
      </div>
    </section>
